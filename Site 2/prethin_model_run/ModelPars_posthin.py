...
model_pars = {
    ...
    'snow_mult': 1.10,              # Snowfall Multiplier [-]
    ...
    'longwave_trans': 0.3,         # Transmittance factor for longwave radiation under canopy [-] (suggested range: 0 - 0.5)
    ...
    'lwi_par1': 2,                  # LWI (Or longwave influence of warm tree trunks at the edges of canopy stands) Parameter 1 (suggested range: 0.5 - 1.5)
    ...
    'snow_unload_par': 0.01,         # Fraction of canopy snow that unloads each day [-] (suggested range: 0-1)
    'canopy_sub_mult': 1.0,          # Canopy sublimation multiplier applied to potential sublimation rate (which is computed for snowpack surface) [-] (suggested range: 5-20)
    'C_S_cap_mult': 4,              # Factor multiplied by LAI to compute canopy snow storage capacity (suggested range: 2-5)
