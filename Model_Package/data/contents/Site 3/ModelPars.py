...
model_pars = {
    ...
    'snow_mult': 1.02,                 # Snowfall Multiplier [-]
    'srad_mult_summer': 1.06,       # Shortwave Radiation Multiplier (summer) [-]
    'srad_mult_winter': 1.06,       # Shortwave Radiation Multiplier (winter) [-]
    'lrad_mult_summer': 1.06,       # Longwave Radiation Multiplier (summer) [-]
    'lrad_mult_winter': 1.06,       # Longwave Radiation Multiplier (winter) [-]
    ...
    'shortwave_trans_diffuse': 0.2, # Transmittance factor for diffuse shortwave radiation under canopy [-] (suggested range: 0 - 0.5)
    'shortwave_trans_direct': 0.2,  # Transmittance factor for direct shortwave radiation under canopy [-] (suggested range: 0 - 0.2)
    ...
    'lwi_par2': 0.2,                # LWI Parameter 2 (suggested range: 0 - 0.5)
    ...
    'albedo_decay_cold': 0.003,     # Albedo Decay Factor for cold snowpack [1/day] (suggested range: 0.01 - 0.05)
    'albedo_decay_warm': 0.03,      # Albedo Decay Factor for cold snowpack [1/day] (suggested range: 0.05 - 0.15)
    ...
    'canopy_sub_mult': 0.3,          # Canopy sublimation multiplier applied to potential sublimation rate (which is computed for snowpack surface) [-] (suggested range: 5-20)
    ...
    'max_sub_pct_when_snow': 0.02,   # Maximum fraction of snowfall that can be sublimation when snowing (suggested range: 0-0.5)
    'max_melt_pct_when_snow': 0.02,  # Maximum fraction of snowfall that can be melt when snowing (suggested range: 0-0.5)
    ...
    'H': 400,                       # Thickness of surface soil layer [mm] 
