...
pars['VegHT_File'] = r'InputData\SpatialData\chapman_CHM.tif'
# Canopy cover raster to get data from
pars['VegCover_File'] = r'InputData\SpatialData\chapman_CC.tif'
# Cutline file to clip out shape (will only be used if pars['Cutline_File'] is not an empty string)
pars['Cutline_File'] = ''

pars['NSWE'] = [3812975, 3812575, 462400, 462900]       # Spatial Extents
