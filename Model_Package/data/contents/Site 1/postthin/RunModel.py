...
import Initialize
import Model
import ModelPars_postthin
model_pars = ModelPars_postthin.model_pars
program_pars = {}
...
if program_pars['SimulationName'] == 'EntireArea_Daily_2021':
    ...
    program_pars['POIDir'] = r'D:\RD_python_wok_3D_veg\CS_site\InputData\POIs'                       # POI directory
    program_pars['UseWindModel'] = True                             # Use Wind Model


if program_pars['SimulationName'] == 'SnowtographyArea_2023':
    program_pars['ForcingSetName'] = 'DailyNLDASData'               # Name of forcing dataset to use as model input
    program_pars['ModelTimestep'] = 1                               # 0: Hourly, 1: Daily
    program_pars['UseHourlySFIFiles'] = False                       # Use hourly solar forcing files (only for hourly model)
    program_pars['StartDate'] = date(2022, 10, 1)                   # Simulation Start Date
    program_pars['EndDate'] = date(2023, 2, 28)                     # Simulation End Date
    program_pars['SimulationType'] = 1                              # 0: Entire Area, 1: Subset Area, 2: POIs only
    program_pars['NSWE'] = [3901800.697,3901678.999,437999.0693,438660.733]       # Spatial Extents of Subset Area
    program_pars['MaxChunkSize'] = 25000                            # Maximum size (in pixels) of each model chunk
    program_pars['UseWindModel'] = True                             # Use Wind Model
    model_pars['swe_i'] = 100

if program_pars['SimulationName'] == 'SnowtographyArea_1622':
    program_pars['ForcingSetName'] = 'DailyNLDASData'               # Name of forcing dataset to use as model input
    program_pars['ModelTimestep'] = 1                               # 0: Hourly, 1: Daily
    program_pars['UseHourlySFIFiles'] = False                       # Use hourly solar forcing files (only for hourly model)
    program_pars['StartDate'] = date(2016, 10, 1)                   # Simulation Start Date
...
if program_pars['SimulationName'] == 'SnowtographyArea_2023_old':
    program_pars['ForcingSetName'] = 'DailyNLDASData'               # Name of forcing dataset to use as model input
    program_pars['ModelTimestep'] = 1                               # 0: Hourly, 1: Daily
    program_pars['UseHourlySFIFiles'] = False                       # Use hourly solar forcing files (only for hourly model)
    program_pars['StartDate'] = date(2022, 10, 1)                   # Simulation Start Date
    program_pars['EndDate'] = date(2023, 2, 28)                     # Simulation End Date
    program_pars['SimulationType'] = 1                              # 0: Entire Area, 1: Subset Area, 2: POIs only
    program_pars['NSWE'] = [3902000, 3901400, 437800, 439000]       # Spatial Extents of Subset Area
    program_pars['MaxChunkSize'] = 25000                            # Maximum size (in pixels) of each model chunk 
    program_pars['UseWindModel'] = True                             # Use Wind Model
    model_pars['swe_i'] = 100

if program_pars['SimulationName'] == 'SnowtographyArea_1622_old':
    program_pars['ForcingSetName'] = 'DailyNLDASData'               # Name of forcing dataset to use as model input
    program_pars['ModelTimestep'] = 1                               # 0: Hourly, 1: Daily
    program_pars['UseHourlySFIFiles'] = False                       # Use hourly solar forcing files (only for hourly model)
    program_pars['StartDate'] = date(2016, 10, 1)                   # Simulation Start Date
...
if program_pars['SimulationName'] == 'SnowtographyArea_Hourly_2023_02_10':
    model_pars['srad_mult_summer'] = 1
    model_pars['srad_mult_winter'] = 1
    model_pars['lrad_mult_summer'] = 1
    model_pars['lrad_mult_winter'] = 1
    model_pars['longwave_trans'] = 0
    model_pars['shortwave_trans_diffuse'] = 0.5
    model_pars['shortwave_trans_direct'] = 0.5
    ...
    program_pars['StartDate'] = date(2023, 2, 10)                   # Simulation Start Date
    program_pars['EndDate'] = date(2023, 2, 10)                     # Simulation End Date
    program_pars['SimulationType'] = 1                              # 0: Entire Area, 1: Subset Area, 2: POIs only
    program_pars['NSWE'] = [3902000, 3901400, 437800, 439000]       # Spatial Extents of Subset Area
    program_pars['MaxChunkSize'] = 25000                            # Maximum size (in pixels) of each model chunk 
    program_pars['UseWindModel'] = True                             # Use Wind Model
