...
pars['EndYear'] = 2023                      # End Year
pars['EndMonth'] = 2                        # End Month
pars['ForcingSet'] = 'DailyNLDASData'           # Forcing set used to create wind index maps (wind direction, as well as precipitation and temperature thresholds could be used)
...
pars['WindDirs'] = range(0, 360, 30)        # Directions to compute wind index maps for
pars['WindEffectResizeFactor'] = 7          # Filter applied to soften edges around canopy
